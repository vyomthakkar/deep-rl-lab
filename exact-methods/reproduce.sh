...
echo "[2/3] Generating 4room PI figure (default slip)..."
python -m rlx.scripts.make_4room_figure --algo pi --eval_tol 1e-8 --max_eval_iters 1000 --outfile runs/figs/4room_pi.png "$@"
